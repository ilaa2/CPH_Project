...
export function SiteHeader({ auth, onCartClick }) {
    ...
    return (
        <>
                    ...
                    <div className="h-16 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {/* Hide Cart for Admin */
                                (user?.role !== 'admin') && (
                                    <button
                                        onClick={() => handleProtectedAction(onCartClick || (() => setInternalCartOpen(true)))}
            ...
            {/* Internal CartPanel - only rendered when SiteHeader is used standalone (no onCartClick from parent) */}
            {!onCartClick && (
                <CartPanel
                    open={internalCartOpen}
                    setOpen={setInternalCartOpen}
