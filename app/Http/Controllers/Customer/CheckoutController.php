        ...
        try {
            return DB::transaction(function () {
                ...
                $pesanan = Pesanan::create([
                    ...
                    'ekspedisi'         => isset($pengiriman['service']) ? ($pengiriman['name'] . ' - ' . $pengiriman['service']) : ($pengiriman['name'] ?? null),
                    'estimasi'          => $pengiriman['etd'] ?? null,
                    'tanggal'           => now(),
                    // Payment columns
                ...
                foreach ($cartItems as $item) {
                    ...
                    // Validasi stok (tetap dicek, tapi tidak dikurangi di sini)
                    ...
                    // Stok akan dikurangi saat menerima notifikasi settlement dari Midtrans
                    // Ini mencegah stok berkurang untuk pesanan yang tidak jadi dibayar
                }
